 ...
 */
@Component
public class FetchInstagramContentHandler implements JobHandler {
    ...
    private final Logger log = Logger.getLogger(FetchInstagramContentHandler.class.getSimpleName());
